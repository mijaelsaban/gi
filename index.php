...
<div id="featured">
	<div class="page">
        <div id="sliderHome">
            ...
            <!--
            <div>
                <img src="images/slider-cercos-perimetrales-electrificados.png" />
                <div>
                    <h2>Cercos perimetrales electrificados</h2>
                    <p>La eficiencia de este sistema complementario<br /> lo ha convertido en la opción mas disuasiva<br /> y segura de estos tiempos.</p>
                    <a href="cercos-perimetrales-electrificados" class="bt">Ver Más</a>
                </div>
            </div>
            <div>
                <img src="images/slider-cercos-perimetrales-electrificados.png" border="0" usemap="#Map" />
                <map name="Map" id="Map">
                <area shape="rect" coords="95,65,388,333" href="cercos-perimetrales-electrificados" alt="instale un cerco eléctrico" />
                </map>
			</div>
            <div>
                <img src="images/slider-cable-sensor-microfono.png" />
                <div>
                    <h2>Cable sensor microfónico</h2>
                    <p>Funciona como un gran micrófono de alta fidelidad, Transporta la superficie en la que se instala en un gran sensor.</p>
                    <a href="cable-sensor-microfonico" class="bt">Ver Más</a>
                </div>
            </div>
            <div> 
            	<img src="images/slider-pack-antientradera.jpg" border="0" usemap="#Map2" />
                <map name="Map2" id="Map2">
                <area shape="rect" coords="40,40,359,355" href="sistema-antientraderas" alt="antientradera" />
                </map>
                <div>
                    <h2>&nbsp;</h2>
                </div>
